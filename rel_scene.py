...
from utils.roi_iterator import ROIdatalayer
...
def get_iterators(data_dir, img_list, batch_size_all, image_size, aug_dict, data_norm, seed):
    ...
    train = ROIdatalayer(data_dir=data_dir, img_list_file=img_list[0], batch_size=batch_size_all[0],
    ...
    val = ROIdatalayer(data_dir=data_dir, img_list_file=img_list[1], batch_size=batch_size_all[1],
