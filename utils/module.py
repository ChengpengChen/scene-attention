...
from mxnet.model import load_checkpoint, BatchEndParam
...
class MyModule(BaseModule):
    ...
    def fit_(self, train_data, eval_data=None, eval_metric='acc',
             ...
             validation_metric=None, monitor=None, eval_period=1):
    ...
    def load(prefix, epoch, load_optimizer_states=False, **kwargs):
        ...
        mod = MyModule(symbol=sym, **kwargs)
    ...
    def bind(self, data_shapes, label_shapes=None, for_training=True,
        ...
        if shared_module is not None:
            assert isinstance(shared_module, MyModule) and \
